    ...
    <section id="community" className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="text-center p-6 bg-[#1C1C1C] rounded-xl border border-[#2A2A2A]"
              >
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-[#1C1C1C] to-[#141414] rounded-2xl border border-[#2A2A2A] p-8 md:p-12 text-center"
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {["Authentic Knowledge", "Safe Community", "Cultural Diversity"].map((value) => (
              <div key={value} className="p-4 bg-[#0B0B0B] rounded-lg">
