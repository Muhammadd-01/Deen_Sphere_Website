...
const BackgroundAnimation = () => {
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
            ...
            <motion.div
                className="absolute top-20 left-10 w-32 h-32 border border-[#F5B400]/10 rounded-full"
                animate={{ rotate: 360 }}
                transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            />
            <motion.div
                className="absolute top-40 right-20 w-24 h-24 border border-[#F5B400]/10"
                style={{ transform: "rotate(45deg)" }}
                animate={{ rotate: [45, 135, 45] }}
                transition={{ duration: 30, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute bottom-40 left-20 w-20 h-20 border border-[#F5B400]/10"
                animate={{ rotate: [0, 90, 0], scale: [1, 1.1, 1] }}
                transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute top-1/3 left-1/4 w-16 h-16 border border-[#F5B400]/5 rounded-full"
            ...
            <motion.div
                className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-to-br from-[#F5B400]/5 to-transparent rounded-full blur-3xl"
                animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.4, 0.2] }}
                transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-gradient-to-tr from-[#E6A800]/5 to-transparent rounded-full blur-3xl"
                animate={{ scale: [1.2, 1, 1.2], opacity: [0.15, 0.3, 0.15] }}
                transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
            />
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-[#F5B400]/3 to-transparent rounded-full blur-3xl"
            ...
            <motion.div
                className="absolute bottom-20 right-32 w-16 h-16"
